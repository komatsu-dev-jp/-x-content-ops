...
- 投稿数: 7件（week00-p1, week01-p1, week01-p2, week01-p2b, week01-p3, week01-p4, week01-p5）※p2b/p4bはスクショのみでpost_log未記録だった投稿を今回追加登録
- 画像あり / なし: screenshot 1件（week01-p4 UIスクショ型） / none 4件 / 未設定3件
...
|---|---|---|---|---:|---:|---|
| 1 | week01-p2 | あるある型 | noon | 0.0120 | - | 今週唯一profile_visitが発生（1/83）。ただしn=83で低n |
| 2 | week01-p4b | （未設定・記憶バイアス系） | - | 0.0000 | - | likes=2と反応はあるがpv=0。post_log未記録だった投稿を今回追加 |
| 3 | week01-p1 | 問題提起型 | morning | 0.0000 | - | 印象数は107まで伸びたがpv=0 |
| 4 | week01-p3 | 失敗告白型 | morning | 0.0000 | - | 当初scheduled表記だったが実際は6/28に投稿済みと判明、修正 |
| 5 | week01-p4 | UIスクショ型 | night | - | - | アナリティクス未取得 |

縮小率（信頼度補正）順でも上位は同じくweek01-p2（あるある型・noon）。ただしimp=83で「低n」のため**勝ち確定ではなく仮説**として扱う。
